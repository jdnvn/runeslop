...
//	notifyItemSpawn(item, i + baseX, j + baseY);
  ...
  */
	...
	public String getDocumentBaseHost() {
		...
		if (super.gameFrame != null) {
			return ""; // websitehere.com <- removed for Jframe to work
		} else {
 ...
 //		   return;
		...
		if(signlink.cache_dat != null)
		{
			...
			for(int r1 = 0; r1 < 5; r1++)
				redStones[r1] = new Sprite(streamLoader_2, "coins", r1);
	...
	private void drawLoginScreen(boolean flag)
	{
		...
		if(loginScreenState == 2)
		{
			...
			if(!flag)
			{
				...
				chatTextDrawingArea.method382(0xffffff, i1, "Log in", l1 + 5, true);
				i1 = c / 2 + 80;
				aBackground_967.drawBackground(i1 - 73, l1 - 20);
		...
		{
						chatTextDrawingArea.method382(0xffff00, c / 2, "New User", c1 / 2 - 60, true);
			int k = c1 / 2 - 35;
			...
			chatTextDrawingArea.method382(0xffffff, j1, "Back", i2 + 5, true);
		}
		aRSImageProducer_1109.drawGraphics(171, super.graphics, 202);
		if(welcomeScreenRaised)
		{
