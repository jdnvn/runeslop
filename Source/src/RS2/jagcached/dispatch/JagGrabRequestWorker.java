...
import RS2.jagcached.net.jaggrab.JagGrabResponse;
...
public final class JagGrabRequestWorker extends RequestWorker<JagGrabRequest> {
	...
	@Override
	protected ChannelRequest<JagGrabRequest> nextRequest()
	...
	protected void service(IndexedFileSystem fs, Channel channel,
			JagGrabRequest request) throws IOException {
		...
		if (buf == null) {
			...
			channel.write(new JagGrabResponse(wrapped)).addListener(
