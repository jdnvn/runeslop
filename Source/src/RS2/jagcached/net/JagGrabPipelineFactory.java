...
import RS2.jagcached.net.jaggrab.JagGrabRequestDecoder;
import RS2.jagcached.net.jaggrab.JagGrabResponseEncoder;
...
public final class JagGrabPipelineFactory implements ChannelPipelineFactory {
	 ...
	 */
	private static final ChannelBuffer DOUBLE_LINE_FEED_DELIMITER = ChannelBuffers
			.buffer(2);
	...
	public ChannelPipeline getPipeline() throws Exception {
		...
		pipeline.addLast("framer", new DelimiterBasedFrameDecoder(
				MAX_REQUEST_LENGTH, DOUBLE_LINE_FEED_DELIMITER));
		...
		pipeline.addLast("timeout", new IdleStateHandler(timer,
				NetworkConstants.IDLE_TIME, 0, 0));
